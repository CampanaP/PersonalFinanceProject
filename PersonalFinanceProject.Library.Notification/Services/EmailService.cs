...
using PersonalFinanceProject.Library.Notification.Enums;
using PersonalFinanceProject.Library.Notification.Interfaces.Services;
using PersonalFinanceProject.Library.Notification.Settings;

namespace PersonalFinanceProject.Library.Notification.Services
{
    [ScopedLifetime]
